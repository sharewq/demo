...
public class Symm3DES {
    ...
    public static void main(String[] args) {
        Symm3DES test = new Symm3DES();
        String dataStr = "毒素发";      //数据
        String SPKEY = "1234";          //密钥
        System.out.println("1。分配的SPKEY为: " + SPKEY);
        System.out.println("2。的内容为: " + dataStr);
        String reValue = test.get3DESEncrypt(dataStr, SPKEY);
        //去掉首位空格-
